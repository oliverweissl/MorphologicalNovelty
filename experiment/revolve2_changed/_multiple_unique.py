...
def multiple_unique(
    ...
    selection_function: Callable[[List[Genotype], List[Fitness], List[Novelty]], int],
) -> List[int]:
    """
    ...
    assert len(population) == len(novelty)
    ...
    for _ in range(selection_size):
        ...
        while new_individual is False:
            selected_individual = selection_function(population, fitnesses, novelty)
